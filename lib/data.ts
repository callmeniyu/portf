...
export const testimonials: Testimonial[] = [
  {
    id: "test-1",
    name: "Rishad",
    role: "Founder of Oastel",
    avatar: "/oastel.png",
    text: "Niyas is the last person I had to go in search of when looking for a developer with a brilliant mind and strong work ethic. Now, OASTEL's tech side is completely in his hands.",
    rating: 5,
    date: "3 weeks ago",
    project: "Booking SaaS Platform",
  },
  {
    id: "Excel TBI",
    name: "Mohan",
    role: "Chief Cordinator, Excel-TBI",
    avatar: "/excel.png",
    text: "Such a talented and obedient lad. His contributions to Excel TBI still ripple through the organization today.",
    rating: 5,
    date: "1 month ago",
    project: "Skill Monetizing Gamified Platform",
  },

  {
    id: "Rayo",
    name: "Rizan",
    role: "CEO, Rayoproductions",
    avatar: "/rayo.png",
    text: "When I thought about expanding my cinematography company into the tech space, Niyas was the first name that popped into my mind.",
    rating: 5,
    date: "1 month ago",
    project: "Tech Lead",
  },
  {
    id: "Divine Destination Discoveries",
    name: "Divine Destination Discoveries",
    role: "Travel Agency",
    avatar: "/ddd.png",
    text: "Straightforward and reliable. I've never met someone so nerdy yet friendly. His ability to understand my requirements and build exactly what I had in mind was amazing.",
    rating: 5,
    date: "2 months ago",
  ...
  {
    id: "Yatikitchen",
    name: "Yati Binti Maryam",
    role: "Owner, Yatikichen",
    avatar: "/yatikitchen.png",
    text: "A well-organized and strategic young professional with plenty of technical skills at his disposal.",
    rating: 5,
    date: "3 months ago",
    project: "UI/UX",
  },
